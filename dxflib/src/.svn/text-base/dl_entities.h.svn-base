...
struct DL_3dFaceData {
     ...
     * Parameters: see member variables.
     */
    DL_3dFaceData(double lx1, double ly1, double lz1,
                double lx2, double ly2, double lz2,
...
struct DL_VertexData {
     ...
     * Parameters: see member variables.
     */
    DL_VertexData(double px, double py, double pz,
                  double pBulge, int pflags, int pi1 = 0, int pi2 = 0, int pi3 = 0,int pi4 = 0) {
        x = px;
        y = py;
        z = pz;
        bulge = pBulge;
