...
#ifndef RFASURFACEBYSHAPE_H
#define RFASURFACEBYSHAPE_H


#define XML_NODE_COLORBYSHAPE "RFAColorByShape"
#define XML_NODE_SURFACEBYSHAPE "RFASurfaceByShape"
...
namespace cop
{
  ...
  public:
    ...
    virtual std::string GetName(){return XML_NODE_SURFACEBYSHAPE;}
